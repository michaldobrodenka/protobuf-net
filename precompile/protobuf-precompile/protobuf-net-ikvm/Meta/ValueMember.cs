            ...
            try
            {
                ...
                {                    
                    ...
                    Helpers.DebugAssert(underlyingItemType == ser.ExpectedType
                        || (TypeComparator.Eq(ser.ExpectedType, typeof(object)) && !Helpers.IsValueType(underlyingItemType))
...
{
#if FEAT_IKVM
	public static bool Eq(IKVM.Reflection.Type a, System.Type b)
	{
		var af = a.FullName;
		var bf = b.FullName;
...
#else
	public static bool Eq(System.Type a, System.Type b)
	{
		return a == b;
	}
#endif
