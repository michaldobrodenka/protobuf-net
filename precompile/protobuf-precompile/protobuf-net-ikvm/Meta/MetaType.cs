...
.IsDefined(model.MapType(typeof(FlagsAttribute)), false))
                        ...
                        )
                    {
                        ...
                        {
                            object enumVal;
#if WINRT || PORTABLE || CF || FX11 || NETSTANDARD1_3 || NETSTANDARD1_4 || NETSTANDARD1_5 || NETSTANDARD1_6
                            ...
                            enumVal = Convert.ChangeType(field.GetRawConstantValue(), Enum.GetUnderlyingType(field.FieldType.GetEnumUnderlyingSystemType()));
#else
                            enumVal = field.GetRawConstantValue();
#endif
