...
namespace IKVM.Reflection
{
	...
	public sealed class Universe : IDisposable
	{
		...
		{
			get { return Load("netstandard"); }
		}

		public Assembly ExportFramework { get; set; }
		...
		{
			get { return GetLoadedAssembly("netstandard") != null; }
		}
		...
		private Assembly LoadAssembly(RawModule module)
		{
		...
		public Assembly LoadFileAlone(string path)
		{
			try
			{
				using (RawModule module = OpenRawModule(path))
				{
					var asm = module.ToAssembly();
					return asm;
				}
			}
			catch (IOException x)
