...
namespace IKVM.Reflection
{
	...
	public abstract class Type : MemberInfo, IGenericContext, IGenericBinder
	{
		...
		public System.Type GetEnumUnderlyingSystemType()
		{
			var zz = __GetSystemType(GetTypeCode(GetEnumUnderlyingType()));
			return zz;
		}
		...
		public Assembly ForwardingAssembly { get; set; }

		public Assembly ExportAssembly
		{
			get
			{
				var fileName = Path.GetFileName(Assembly.Location);
				if (fileName.StartsWith("System.", StringComparison.InvariantCultureIgnoreCase) ||
					fileName.StartsWith("netstandard.", StringComparison.InvariantCultureIgnoreCase))
					return Module.universe.ExportFramework; // map this to netstandard
		...
		{
			get { return ForwardingAssembly != null ? ForwardingAssembly : Module.Assembly; }
		}
		...
		private bool ResolvePotentialEnumOrValueType()
		{
			if (this.Assembly == this.Universe.Mscorlib
				...
				|| this.Assembly.GetName().Name.Equals("netstandard", StringComparison.OrdinalIgnoreCase)
